...
public class ServerProtocol implements Runnable {
        ...
        */
        ...
        public void doCommand(String msg) throws IllegalArgumentException, IOException{
                String[] splitCommand = msg.split(" ");
                String command = splitCommand[0].toLowerCase();
                int numArgs = splitCommand.length-1;
        ...
        public void sendError(int errorcode){
        	handler.server.serverUpdate("Sending error to client. ["+Errors.getError(1, errorcode)+"]");
